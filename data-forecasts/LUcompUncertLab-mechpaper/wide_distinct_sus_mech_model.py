...
if __name__ == "__main__":
    ...
    current_season_flu = flu.loc[ (flu.date >= "2022-09-15") & (flu.date <= END_DATE) ]
    ...
    def hier_sir_model( T, C, SEASONS, ttl, training_data__hosps=None, training_data__deaths=None, future=0):
        ...
        percent_sus = numpyro.sample("percent_sus", dist.Uniform(0*jnp.ones(SEASONS,) ,1*jnp.ones(SEASONS,)) )
