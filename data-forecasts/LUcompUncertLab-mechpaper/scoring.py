...
def median_absolute_error(quantiles,y=None):
    import pandas as pd
    ...
    #--collect median
    median = quantiles.loc[quantiles["quantile"] == 0.50, "value"].values
    return float( median - y )

def coverage(quantiles,y=None):
    import pandas as pd
    ...
    for alpha in alphas:
        ...
        covers["level"].append(upper_alpha-lower_alpha)
        covers["cover"].append( 1 if y>lower and y<upper else 0 )
