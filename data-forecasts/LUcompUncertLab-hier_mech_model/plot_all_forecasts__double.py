...
if __name__ == "__main__":
    ...
    forecasts = pd.read_csv("./new_forecasts/{:s}-{:s}.csv".format(monday_submission,model_name))
    ...
    pdf = matplotlib.backends.backend_pdf.PdfPages("./monday_submission_viz/{:s}-{:s}__double.pdf".format(monday_submission,model_name))
