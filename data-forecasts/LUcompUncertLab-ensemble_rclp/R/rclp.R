...
# targets are defined.
reference_date <- "2022-11-12"#args[1]
...
results_path <- "./2022-11-14-LUcompUncertLab-ensemble_rclp.csv" #args[5]
...
component_forecasts <- covidHubUtils::load_forecasts_repo(
  ...
  forecast_dates = seq(ymd('2022-09-05'),ymd('2022-11-14'), by = '1 week'),
  locations = NULL,
  types = "quantile",
  targets = NULL,
  hub = "FluSight",
